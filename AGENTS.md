...
When writing or modifying Rust code, keep every .rs file under 2000 lines. If a file approaches this limit, proactively split functionality into submodules (mod) to keep files short and single-purpose.
